...
import { fileMd5 } from 'appium-selendroid-installer'; // TODO: use appium-support
import { path as unicodeIMEPath } from 'appium-android-ime';
import { path as settingsApkPath } from 'io.appiupm.settings';
...
helpers.resetApp = async function (adb, localApkPath, pkg, fastReset) {
  if (fastReset) {
    ...
    let apkMd5 = await fileMd5(localApkPath);
